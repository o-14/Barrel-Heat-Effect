"""Build the puff-overlap DLL in this worktree, with game deployment disabled."""
...
commands=[('overlap-configure.log',[str(cmake),'-S',str(ROOT/'GunHeatPlugin'),'-B',str(BUILD),'-G','Ninja',
    ...
    ('overlap-build.log',[str(clean.NINJA),'-C',str(BUILD),'-j','4','GunHeat.dll'])]
